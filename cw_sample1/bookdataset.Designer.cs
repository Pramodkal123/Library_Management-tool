...
namespace cw_sample1 {
    ...
    public partial class bookdataset : global::System.Data.DataSet {
        ...
        public partial class bookDataTable : global::System.Data.TypedTableBase<bookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bookRow AddbookRow(string bookid, string bname, string genre, string author, string publisher, string status) {
...
namespace cw_sample1.bookdatasetTableAdapters {
    ...
    public partial class bookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[book] WHERE (([bookid] = @Original_bookid) AND ((@IsNull_bname = 1 AND [bname] IS NULL) OR ([bname] = @Original_bname)) AND ((@IsNull_genre = 1 AND [genre] IS NULL) OR ([genre] = @Original_genre)) AND ((@IsNull_author = 1 AND [author] IS NULL) OR ([author] = @Original_author)) AND ((@IsNull_publisher = 1 AND [publisher] IS NULL) OR ([publisher] = @Original_publisher)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[book] ([bookid], [bname], [genre], [author], [publisher], [sta" +
                "tus]) VALUES (@bookid, @bname, @genre, @author, @publisher, @status);\r\nSELECT bo" +
                "okid, bname, genre, author, publisher, status FROM book WHERE (bookid = @bookid)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[book] SET [bookid] = @bookid, [bname] = @bname, [genre] = @genre, [author] = @author, [publisher] = @publisher, [status] = @status WHERE (([bookid] = @Original_bookid) AND ((@IsNull_bname = 1 AND [bname] IS NULL) OR ([bname] = @Original_bname)) AND ((@IsNull_genre = 1 AND [genre] IS NULL) OR ([genre] = @Original_genre)) AND ((@IsNull_author = 1 AND [author] IS NULL) OR ([author] = @Original_author)) AND ((@IsNull_publisher = 1 AND [publisher] IS NULL) OR ([publisher] = @Original_publisher)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)));
SELECT bookid, bname, genre, author, publisher, status FROM book WHERE (bookid = @bookid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT bookid, bname, genre, author, publisher, status FROM dbo.book";
        ...
        public virtual int Delete(string Original_bookid, string Original_bname, string Original_genre, string Original_author, string Original_publisher, string Original_status) {
        ...
        public virtual int Insert(string bookid, string bname, string genre, string author, string publisher, string status) {
            if ((bookid == null)) {
        ...
        public virtual int Update(string bookid, string bname, string genre, string author, string publisher, string status, string Original_bookid, string Original_bname, string Original_genre, string Original_author, string Original_publisher, string Original_status) {
            if ((bookid == null)) {
                throw new global::System.ArgumentNullException("bookid");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string bname, string genre, string author, string publisher, string status, string Original_bookid, string Original_bname, string Original_genre, string Original_author, string Original_publisher, string Original_status) {
            return this.Update(Original_bookid, bname, genre, author, publisher, status, Original_bookid, Original_bname, Original_genre, Original_author, Original_publisher, Original_status);
        }
    }
